  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text(localization?.translate('app_title') ?? 'Fallback Title', style: TextStyle(color: Colors.white)),
        actions: [
          IconButton(
            ...
            onPressed: () {
              showDialog(
                ...
                builder: (context) => AlertDialog(
                  title: Text(localization?.translate('instructions') ?? 'Fallback Instructions'),
                  content: Text(localization?.translate('instructions_content') ?? 'Fallback Instructions Content'),
                  actions: [
                    TextButton(
                ...
                Expanded(
                  ...
                  child: selectedAirplane != null
                    ...
                    changeLanguage: widget.changeLanguage,
                      ...
                      : Center(
                    child: Text(
                      localization?.translate('select_airplane') ?? 'Select an airplane to view details',
